...
class LengthUnitCalculator:
    def calc(self, amount, fromUnit, toUnit):
		...
		if toUnit == "in": toUnit = "inch"
		mi  = {'mi': 1, 'yd': 1760.0, 'ft': 1760*3, 'inch': 1760*36}
		ft  = {'ft': 1, 'mi': 1.0/(1760*3), 'yd': (1.0/3), 'inch': 12}
		inch  = {'inch': 1, 'mi': 1.0/(1760*36), 'yd': 1.0/36, 'ft': 1.0/12}
		yd  = {'yd': 1, 'mi': 1.0/1760, 'inch': 36, 'ft': 3}
		result = (eval(fromUnit).get(toUnit)) * amount
		return result
